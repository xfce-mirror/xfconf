...
static gboolean
parse_verbose_option(const gchar *option_name,
                     const gchar *value,
                     gpointer data,
                     GError **error)
{
...
static GOptionEntry entries[] = {
    ...
    { "list", 'l', G_OPTION_FLAG_IN_MAIN, G_OPTION_ARG_NONE, &list,
      ...
      NULL },
    { "verbose", 'v', G_OPTION_FLAG_IN_MAIN | G_OPTION_FLAG_OPTIONAL_ARG | G_OPTION_FLAG_NO_ARG, G_OPTION_ARG_CALLBACK, parse_verbose_option,
